...
import 'package:slitem/pages/home_details_page.dart';
import 'package:slitem/widgets/home_widgets/catelog_image.dart';
      ...
      children: [
        ...
        Expanded(
          ...
          children: [
            ...
            catelog.category!.text.textStyle(context.captionStyle!).make(),
            10.heightBox,
            ButtonBar(
              alignment: MainAxisAlignment.spaceBetween,
              buttonPadding: EdgeInsets.zero,
              children: [
                '\LKR${catelog.price}'.text.bold.xl.make(),
